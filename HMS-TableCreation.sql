...
-- SCENARIO 1
insert into patient (  F_name,L_name,  Phone_no, email, DOB, blood_group, gender, address )
values              ( 'Yasmin',' Khaled', '0121111111', 'yasmin.khaled@email.com', '1997-06-15', 'AB+', 'F', '888 Helwan St, Cairo' );
select* from  PATIENT
